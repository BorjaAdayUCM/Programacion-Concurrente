...
public class Mensaje_Agregar_Ficheros extends Mensaje {
	
	private String id;
	private ArrayList<String> listaFicheros;

	public Mensaje_Agregar_Ficheros(String origen, String destino, TipoMensaje tipoMensaje, String id, ArrayList<String> listaFicheros) {
