...
public class ModeloTablaFicherosServidor extends ModeloTabla<String> {


	public ModeloTablaFicherosServidor(String[] columnIdEventos, OyenteServidor oyenteServidor) {
